...
const ViewBookDetails = () => {
  ...
  return (
    ...
    {Data && (
        ...
        <div className=' bg-zinc-800 rounded p-4 h-[60vh] lg:h-[88vh] w-full lg:w-3/6 flex  items-center justify-center '><img src={Data.url} alt='/' className='h-[50vh] lg:h-[70vh] rounded'/>
        </div>
